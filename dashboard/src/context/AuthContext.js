...
export const AuthProvider = ({children}) =>{
    ...
    const userDetails = async (profileId) => {
        try {
          const response = await fetch(
            `https://api.veloxarion.com/api/user-profile/${profileId ? profileId : user?.profile_id}/`,
            {
              method: "GET",
              headers: {
    ...
    const RequestOTP = async(e) =>{
      ...
      setLoader(true)
      try{
          let response = await fetch('https://api.veloxarion.com/api/request-otp/', {
              method: 'POST',
              headers: {
                  "Content-Type": "application/json"
              },
    ...
    const LoginUser = async(e) =>{
        ...
        setShowAnimation(true)
        try{
            let response = await fetch('https://api.veloxarion.com/api/login/', {
                method: 'POST',
                headers: {
                    "Content-Type": "application/json",
    ...
    const ForgotPasssword = async(e) =>{
        ...
        try{
            let response = await fetch('https://api.veloxarion.com/api/forget-password/', {
                method: 'POST',
                headers: {
                    "Content-Type": "application/json",
    ...
    const updateToken = async () =>{
        let response = await fetch('https://api.veloxarion.com/api/token/refresh/', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
            },
