...
export const ClientBankCard = () =>{
  ...
  const IndividualBankCard = async(id) =>{
    ...
    let response = await fetch(`https://api.amanilightequity.com/api/bank-card/${id}/`, {
      method: "GET",
      headers: {
        ...
        <div>
          ...
          <section className='py-4'>
            <div className="d-block d-md-flex  justify-content-between align-items-center height-100">
              ...
              <div>
                <div className='pt-3'>
                  <Link className='Link' to='/dashboard/payment-gateway/bank-card/add/' >
