...
export default function Stp_Account() {

    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="STP Account" breadcrumbTitleTwo="Trading">
                            ...
                            <div className="col-xl-8 col-lg-7">
                                <div className="account-detail-style1__content">
                                    <div className="intro-box">
                                        <h2>STP Account</h2>
                                        <p>The STP (Straight-Through Processing) Account provides direct market access with no dealing‐desk intervention. It is ideal for traders who want faster execution, transparent pricing, and tighter spreads under real market conditions.</p>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-img">
                                                    <Image src="/assets/images/resources/account-3.JPG" alt="Image" width={350} height={375} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-text">
                                                    <div className="offers-box-text-benefits-box">
                                                        ...
                                                        <div className="title">
                                                            <h3>Benefits</h3>
                                                            <p>Direct market execution with tighter spreads and faster trade processing.</p>
                                                        </div>
                                                        <div className="list-item">
                                                            <ul>
                                                                <li>
                                                                    <p>Direct access to liquidity providers</p>
                                                                </li>
                                                                <li>
                                                                    <p>Faster execution with minimal requotes</p>
                                                                </li>
                                                                <li>
                                                                    <p>Tighter spreads compared to Standard accounts</p>
                                                                </li>
                                                                <li>
                                                                    <p>No dealing-desk intervention</p>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div className="title">
                                                            ...
                                                            <p>
                                                                You can use either use meta 4 or meta 5 for trading signals.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
