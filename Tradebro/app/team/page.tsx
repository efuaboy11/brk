...
export default function Team_Page() {
    ...
    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Team Members" breadcrumbTitleTwo="About">
                        ...
                        <div className="row">
                                ...
                                <div className="single-team-style1">
                                    ...
                                    <div className="bottom-box">
                                        <div className="left">
                                            ...
                                            <Link href="mailto:emailme">Email me</Link>
                                        </div>
                                        <ul className="right">
                                            <li>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-4.JPG" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>4+ years of experience in Trade analysis.</h6>
                                            <Link href="#">
                                                <i className="icon-play"></i>
                                            </Link>
                                        </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-5.jpg" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>5+ years of experience in trade analysis.</h6>
                                            <Link href="#">
                                                <i className="icon-play"></i>
                                            </Link>
                                        </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-6.jpg" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>5+ years of experience in stock and private equity.</h6>
                                            <Link href="#">
                                                <i className="icon-play"></i>
                                            </Link>
                                        </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-7.JPG" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>5+ years of experience in trading.</h6>
                                            <Link href="#">
                                                <i className="icon-play"></i>
                                            </Link>
                                        </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-8.JPG" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>2+ years of experience in markets.</h6>
                                            <Link href="#">
                                                <i className="icon-play"></i>
                                            </Link>
                                        </div>
                                    ...
                                    <div className="middle-box">
                                        <h3><Link href="#">D.Blessing</Link></h3>
                                        <p>Staff Memeber</p>
                                    </div>
                                    <div className="bottom-box">
                                        <div className="left">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-team-style1">
                                    <div className="top-box">
                                        <div className="img-box">
                                            <Image src="/assets/images/team/team-9.JPG" alt="Image" width={170} height={170} priority />
                                        </div>
                                        <div className="text-box">
                                            <h6>8+ years of experience in IT.</h6>
                                            <Link href="#">
                                                <i className="icon-play"></i>
                                            </Link>
                                        </div>
                ...
                <section className="awards-style1 awards-style1--style2">
                    <div className="container">
                            ...
                            <div className="col-xl-4 col-lg-4">
                                <div className="single-awards-style1">
                                    <div className="single-awards-style1__shape1">
                                        <Image src="/assets/images/shapes/awards-v1-1.png" alt="Shape" width={210} height={323} priority />
                                    </div>
                                    <div className="icon">
                                        <span className="icon-trophy"><span className="path1"></span><span className="path2"></span><span
