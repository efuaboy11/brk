...
export default function Demo_Account() {

    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Demo Account" breadcrumbTitleTwo="Trading">
                            ...
                            <div className="col-xl-8 col-lg-7">
                                <div className="account-detail-style1__content">
                                    <div className="intro-box">
                                        <h2>Demo Account</h2>
                                        <p>The Demo Account gives traders a risk-free environment to learn, practice, and refine trading strategies using real-time market data—without any financial commitment.</p>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-img">
                                                    <Image src="/assets/images/resources/account-4.JPG" alt="Image" width={350} height={375} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-text">
                                                    <div className="offers-box-text-benefits-box">
                                                        ...
                                                        <div className="title">
                                                            <h3>Benefits</h3>
                                                            <p>Train, test, and build confidence at zero risk.</p>
                                                        </div>
                                                        <div className="list-item">
                                                            <ul>
                                                                <li>
                                                                    <p>Real-time live market simulation</p>
                                                                </li>
                                                                <li>
                                                                    <p>Zero financial risk</p>
                                                                </li>
                                                                <li>
                                                                    <p>Ideal for learning platform tools and features</p>
                                                                </li>
                                                                <li>
                                                                    <p>Test multiple trading strategies</p>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-xl-6 col-lg-12 col-md-6">
                                                    <div className="single-standard-account-info-box">
                                                        ...
                                                        <div className="right">
                                                            <p>Virtual funds (e.g., $10,000 – $100,000)</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-xl-6 col-lg-12 col-md-6">
                                                    <div className="single-standard-account-info-box">
                                                        ...
                                                        <div className="right">
                                                            <p>Same as Standard (up to 1:500)</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-xl-6 col-lg-12 col-md-6">
                                                ...
                                                <div className="col-xl-6 col-lg-12 col-md-6">
                                                    <div className="single-standard-account-info-box">
                                                        ...
                                                        <div className="right">
                                                            <p>Mirrors live conditions (from 1.2 pips)</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-xl-6 col-lg-12 col-md-6">
