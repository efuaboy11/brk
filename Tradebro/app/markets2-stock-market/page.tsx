...
export default function Stock_Marketing() {
    ...
    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Stock Market" breadcrumbTitleTwo="Markets">
                            ...
                            <div className="row">
                                    ...
                                    <div className="trade-forex-style1__content">
                                        <div className="sec-title">
                                            <div className="sub-title">
                                                <h4>A New Way to Trade US and Global Stock Indices</h4>
                                            </div>
                                ...
                                <div className="col-xl-6">
                                    <div className="trade-forex-style1__img">
                                        <Image src="/assets/images/resources/market-v1-2.JPG" alt="Image" width={570} height={525} priority />
                                    </div>
                                </div>
