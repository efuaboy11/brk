...
export default function Trade_Forex() {
    ...
    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Trade Forex" breadcrumbTitleTwo="Markets">
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-6">
                                    <div className="trade-forex-style1__img">
                                        <Image src="/assets/images/resources/market-v1-1.JPG" alt="Image" width={570} height={525} priority />
                                    </div>
                                </div>
