...
export default function Features_Marketing() {
    ...
    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Marijuna Market" breadcrumbTitleTwo="Markets">
                            ...
                            <div className="row">
                                    ...
                                    <div className="trade-forex-style1__content">
                                        <div className="sec-title">
                                            <div className="sub-title">
                                                <h4>Discover the Marijuna Market </h4>
                                            </div>
                                            <h2>As States Legalize Marijuana, Investors See an Opportunity</h2>
                                        </div>
                                        <div className="text">
                                            <p>Marijuana s the world's most commonly cultivated, trafficked, and used illicit drug, and as the push for legalization at home and abroad grows, marijuana is garnering significant attention from investors, manufacturers, and researchers. Despite the plant being illegal under federal law as a Schedule I drug, the U.S. legal marijuana industry was estimated at $10.4 billion in 2018 with 250,000 jobs devoted to the handling of plants, according to New Frontier Data.</p>
                                        </div>
                                ...
                                <div className="col-xl-6">
                                    <div className="trade-forex-style1__img">
                                        <Image src="/assets/images/resources/market-v1-4.JPG" alt="Image" width={570} height={525} priority />
                                    </div>
                                </div>
