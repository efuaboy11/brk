                            ...
                            <div className="col-xl-8 col-lg-7">
                                <div className="account-detail-style1__content">
                                    <div className="intro-box">
                                        <h2>Mini Account</h2>
                                        <p>The Mini Account is perfect for new traders or those wishing to trade smaller lot sizes with reduced capital exposure. It provides a simple, risk-controlled way to enter the markets.</p>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-img">
                                                    <Image src="/assets/images/resources/account-2.JPG" alt="Image" width={350} height={375} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-text">
                                                    <div className="offers-box-text-benefits-box">
                                                        ...
                                                        <div className="title">
                                                            <h3>Benefits</h3>
                                                            <p>Low-entry trading with smaller positions and minimized risk.</p>
                                                        </div>
                                                        <div className="list-item">
                                                            <ul>
                                                                <li>
                                                                    <p>Lower minimum deposit requirements</p>
                                                                </li>
                                                                <li>
                                                                    <p>Smaller lot sizes for safer practice</p>
                                                                </li>
                                                                <li>
                                                                    <p>Reduced financial risk for beginners</p>
                                                                </li>
                                                                <li>
                                                                    <p>Easy transition toward Standard account trading</p>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
