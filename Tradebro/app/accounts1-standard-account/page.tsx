...
export default function Standard_Account() {

    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Standard A/c" breadcrumbTitleTwo="Trading">
                            ...
                            <div className="col-xl-8 col-lg-7">
                                <div className="account-detail-style1__content">
                                    <div className="intro-box">
                                        <h2>Standard a/c</h2>
                                        <p>The Standard Account is designed for everyday traders seeking a balanced and flexible trading experience. It offers competitive trading conditions suitable for both beginners and experienced investors.</p>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-img">
                                                    <Image src="/assets/images/resources/account-1.JPG" alt="Image" width={350} height={375} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-text">
                                                    <div className="offers-box-text-benefits-box">
                                                        ...
                                                        <div className="title">
                                                            <h3>Benefits</h3>
                                                            <p>A versatile account with fair spreads, solid execution, and full market access.</p>
                                                        </div>
                                                        <div className="list-item">
                                                            <ul>
                                                                <li>
                                                                    <p>Competitive spreads and low trading costs</p>
                                                                </li>
                                                                <li>
                                                                    <p>Access to all major trading instruments</p>
                                                                </li>
                                                                <li>
                                                                    <p>Flexible trade sizes and leverage options</p>
                                                                </li>
                                                                <li>
                                                                    <p>Reliable execution with minimal slippage</p>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
