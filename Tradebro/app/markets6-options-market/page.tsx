...
export default function Options_Market() {
    ...
    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Crude oil" breadcrumbTitleTwo="Markets">
                            ...
                            <div className="row">
                                    ...
                                    <div className="trade-forex-style1__content">
                                        <div className="sec-title">
                                            <div className="sub-title">
                                                <h4>Invest in Crude Oil</h4>
                                            </div>
                                            <h2>One of earth most valuable commodities</h2>
                                        </div>
                                        <div className="text">
                                            <p>Crude oil has long been regarded as one of the most valuable commodities in the world, serving as the backbone of industrial development, transportation, and energy production. As a key driver of global economic activity, investing in crude oil presents a unique opportunity for traders, investors, and institutions looking to capitalize on market fluctuations, geopolitical events, and supply-demand dynamics. </p>
                                        </div>
                                ...
                                <div className="col-xl-6">
                                    <div className="trade-forex-style1__img">
                                        <Image src="/assets/images/resources/market-v1-5.JPG" alt="Image" width={570} height={525} priority />
                                    </div>
                                </div>
