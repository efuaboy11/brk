...
export default function Corporate_Account() {

    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Corporate Account" breadcrumbTitleTwo="Trading">
                            ...
                            <div className="col-xl-8 col-lg-7">
                                <div className="account-detail-style1__content">
                                    <div className="intro-box">
                                        ...
                                        <p>The Corporate Account is tailored for businesses and institutions seeking advanced trading solutions, enhanced account management, and professional-level support.</p>
                                    </div>
                                        ...
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-img">
                                                    <Image src="/assets/images/resources/account-5.JPG" alt="Image" width={350} height={375} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-text">
                                                    <div className="offers-box-text-benefits-box">
                                                        ...
                                                        <div className="title">
                                                            <h3>Benefits</h3>
                                                            <p>High-level trading services designed for business needs and large-volume operations.</p>
                                                        </div>
                                                        <div className="list-item">
                                                            <ul>
                                                                <li>
                                                                    <p>Dedicated account and relationship managers</p>
                                                                </li>
                                                                <li>
                                                                    <p>Customized trading conditions for high volumes</p>
                                                                </li>
                                                                <li>
                                                                    <p>Secure multi-user access and permissions</p>
                                                                </li>
                                                                <li>
                                                                    <p>Detailed reporting and audit-ready statements Resources</p>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
