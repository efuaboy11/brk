...
export default function Crypto_Marketing() {
    ...
    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Crypto Market" breadcrumbTitleTwo="Markets">
                            ...
                            <div className="row">
                                    ...
                                    <div className="trade-forex-style1__content">
                                        <div className="sec-title">
                                            <div className="sub-title">
                                                <h4>Bitcoin Spreads</h4>
                                            </div>
                                            <h2>Trade Bitcoin today!!!</h2>
                                        </div>
                                        <div className="text">
                                            <p>Our Bitcoin Spreads let you trade the price of Bitcoin (based on the trusted TeraBit IndexSM) without having to own bitcoins. There's no need for wallets or conversion, since the contracts are settled in US dollars. Best</p>
                                        </div>
                                ...
                                <div className="col-xl-6">
                                    <div className="trade-forex-style1__img">
                                        <Image src="/assets/images/resources/instruments-v1-4.JPG" alt="Image" width={570} height={525} priority />
                                    </div>
                                </div>
