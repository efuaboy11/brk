                                ...
                                <div className="instruments-style1-tab-content-box-item">
                                    ...
                                    <div className="single-instruments-style1">
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__img">
                                                    <Image src="/assets/images/slides/slide-v1-1.jpg" alt="Chart Image" width={540} height={420} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__content">
                                                    <div className="title">
                                                        <h2>Trading Energy Carriers CFDs</h2>
                                                    </div>
                                                    <div className="text">
                                                        <p>Trading Energy Carriers CFDs involves speculating on the price movements of energy assets like oil, natural gas, and gasoline without owning the physical commodities.</p>
                                                    </div>
                                                    <ul className="list-item clearfix">
                                                        <li>
                                                            <div className="icon">
                                    ...
                                    <div className="single-instruments-style1">
                                        <div className="row">
                                            ...
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__content">
                                                    <div className="title">
                                                        <h2>Explore Indicies</h2>
                                                    </div>
                                                    <div className="text">
                                                        <p>Trade CFDs Across Europe, The Americas, and Asia. Nothing But The Most Popular Indices On Star Extreme. Start Trading</p>
                                                    </div>
                                                    <ul className="list-item clearfix">
                                                        <li>
                                                            <div className="icon">
