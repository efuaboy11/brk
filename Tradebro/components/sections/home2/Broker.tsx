...
export default function Broker() {
  return (
    <>
        <section className="trader-broker-style1">
                    ...
                    <div className="col-xl-4">
                        ...
                        <div className="trader-broker-style1__img">
                            <div className="pattern">
                                <Image src="/assets/images/pattern/trader-broker-v1__pattern.png" alt="Pattern" width={640} height={480} priority />
                            </div>
                            <div className="inner">
                                <Image src="/assets/images/resources/choose-v-1.png" alt="Image" width={370} height={370} priority />
                            </div>
                        </div>
                        </FadeIn>
                    </div>
